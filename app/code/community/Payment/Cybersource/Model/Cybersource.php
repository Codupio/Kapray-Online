...
class Payment_Cybersource_Model_Cybersource extends Mage_Payment_Model_Method_Abstract {
    ...
    public function getFormFields() {
        ...
        $fields['ship_to_address_city'] = $shippingAddress->getCity();
        $fields['ship_to_address_country'] = $shippingAddress->getCountry();
        $fields['ship_to_address_line1'] = $shippingAddress->getStreet(1);
